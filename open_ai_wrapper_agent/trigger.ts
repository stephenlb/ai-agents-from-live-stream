...
/**
 * Trigger a task on the open_ai_wrapper_agent agent and print the result.
...
async function main() {
  ...
  const session = await client.sendMessage({
    agentName: 'open_ai_wrapper_agent',
    requestParts: [textPart('Write a one-sentence bedtime story about a unicorn.', 'request')],
  });
